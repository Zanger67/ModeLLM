...
class Message:
    ...
    def __init__(self, 
        ...
        self.speakers  = set(speaker if isinstance(speaker, (list, set)) else {speaker})
        self.listeners = set(listeners) if isinstance(listeners, (list, set)) else \
...
class CommitteeHistory :
    ...
    def __init__(self) :
        ...
        self.notes: Dict[str: List[Note]] = {}      # {author: [Note, Note, ...]}
